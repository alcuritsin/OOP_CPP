...
||
|:---
|**Наследование** - это способность классов наследовать свойства других классов. Под свойствами, в данном случае, понимают переменные и методы.

Наследование позвляет обобщить свойства разных классов и вынести их в отдельный класс.

Наследование отображает отношение меджу классами типа "является" - "is a". Прежде чем что-то от чего-то унаследовать, нужно быть уверенным в том, что это что-то является тем чем-то.

Например:
Кот является животным? Да, а значит класс Кот можно унаследовать от класса Животное.
Мусоровоз является машиной? Да, а значит класс Мусоровоз можно унаследовать от класса Машина. И мусоровоз наследует все свойства машины.

Колесо является машиной? Нет, значит класс Колесо нельзя унаследовать от класса Машина.
Колесо является частью машины, т.е. машина агрегирует (включает в себя) колесо.

Наследование отображает отношение между классами Generalisation/Specialisation (обобщение/уточнение).

При наследовании различают:
- базовый (родительский) класс. Base class.
- дочерний класс. Derived class.

Базовый класс, незнает какие классы от него унаследованы, тем более не знает из чего состоят эти классы.

Дочерний класс знает своего родителя. Но только непосредственного. Дочерний класс не знает сколько родителей у его родителя.

Базовый класс обобщает свойства разных классов. А дочерние классы дополняют свойства базового класса своими.

Например:
Класс Машина (базовый класс).
Класс Мусоровоз (дочерний класс) дополняет машину мусорным баком.
